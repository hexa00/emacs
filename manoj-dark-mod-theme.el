...
(custom-theme-set-faces
 ...
 '(calendar-today ((t (:underline t :bold t :foreground "cornsilk"))))
 ...
 '(custom-variable-button-face ((t (:bold t :underline t :weight bold :background "lightgrey" :foreground "black" :box (quote (:line-width 2 :style released-button))))))
